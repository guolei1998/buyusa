# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2018-01-28 22:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('buyusaapp', '0036_auto_20180128_2156'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='gig',
            name='category',
            field=models.CharField(choices=[('C4', 'Category 4'), ('C2', 'Category 2'), ('C5', 'Category 5'), ('C3', 'Category 3'), ('C1', 'Category 1')], default='', max_length=2),
        ),
        migrations.AlterField(
            model_name='profile',
